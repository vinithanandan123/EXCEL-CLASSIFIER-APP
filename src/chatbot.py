    ...
    def listen_continuous(self):
        ...
        try:
            with sr.Microphone() as source:
             ...
             self.display_async(f"{self.ai_name}: Microphone not found. Please ensure it's connected and drivers are installed.", "ai")
    ...
    def start_listening(self):
        ...
        if not self.listening:
            ...
            if not sr.Microphone.list_microphone_names():
                messagebox.showerror("Microphone Error", "No microphone found. Please connect a microphone to use voice commands.")
                return
